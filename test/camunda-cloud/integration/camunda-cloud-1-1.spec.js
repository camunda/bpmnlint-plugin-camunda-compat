...
const config = {
  extends: 'plugin:camunda-compat/camunda-cloud-1-1'
};

describe('integration - camunda-cloud-1-1', function() {
  ...
  describe('invalid', function() {
    ...
    it('should be invalid (1.1)', async function() {
      ...
      expect(reports[ 'camunda-compat/has-called-decision-or-task-definition' ]).to.have.length(1);
