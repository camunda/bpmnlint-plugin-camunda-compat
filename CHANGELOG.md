...
* `FIX`: recognize `camunda.secrets.<name>` format in `secrets` and stop recommending it below Camunda 8.10 ([camunda/camunda-modeler#6156](https://github.com/camunda/camunda-modeler/issues/6156))
